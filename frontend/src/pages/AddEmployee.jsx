...
const INITIAL = { name: '', email: '', department: '', designation: '', salary: '', joiningDate: '', status: 'Active' }
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="bg-white rounded-2xl shadow p-6 max-w-2xl mx-auto">
            <h2 className="text-lg font-semibold text-gray-700 mb-6">New Employee Details</h2>
